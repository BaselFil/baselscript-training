...
Example form documented by current reference material:
...
write_record file=languages values=("lan","language","Sprache")
```

When editing an existing application, preserve the project's verified `write_record`
parameter spelling if it differs by a supported alias.
